        ...
        <div class="pb-2 text-center hero-content">
          ...
          <div class="row">
            <div class="col-xl-8 offset-xl-2">
              <p class="lead">Este es el historial de tus compras</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section style="margin-bottom: 200px">
      <div class="container">
        <div class="row">
          ...
          >
            <table
              class="table table-borderless table-hover table-responsive-md table-responsive-sm"
              style="overflow-x: scroll !important"
            >
              <thead class="bg-light">
                <tr>
                  <th
                    class="py-4 text-sm text-uppercase"
              ...
              <tbody>
                <tr v-for="item in orders">
                  ...
                  <td
                    ...
                    v-if="item.statusStr === 'En preparación'"
                  >
                    <span class="p-2 badge text-uppercase badge-info-light"
                      >En preparación</span
                    >
                  </td>
                  <td
                    class="py-4 align-middle"
                    v-if="item.statusStr === 'En camino'"
                  >
                    <span class="p-2 badge text-uppercase badge-warning-light"
                      >En camino</span
                    >
                  </td>
                  <td
                    class="py-4 align-middle"
                    v-if="item.statusStr === 'Recibido'"
                  >
                    <span class="p-2 badge text-uppercase badge-success-light"
                      >Recibido</span
                    >
                  </td>
                  <td class="py-4 align-middle">
                    <router-link
                      class="btn btn-outline-dark btn-sm btnAdd"
                      style="
                        font-size: 11px;
                        letter-spacing: 1px;
                        font-weight: 800;
              ...
              <div class="card-body">
                <div class="row">
                  <div class="text-center col-12">
                    <img
                      src="../../../public/assets/icons/empty-cart.png"
                      style="width: 55px; height: 55px; margin-bottom: 35px"
                      alt=""
                    />
...
export default {
  ...
  methods: {
    ...
    getOrders() {
      ...
      axios
        .get(this.$url + "/profile/orders/" + userId, {
          headers: {
